  ...
  return (
    <div className="min-h-screen bg-black text-zinc-100 flex flex-col items-center justify-center p-4 font-sans overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        >
          Premium Linux Terminal & Environment Manager for Android.
        </motion.p>
        ...
        >
          {isSetupComplete ? (
            ...
            <Button 
              onClick={() => navigate(status.isDataDownloaded ? '/setup' : '/sync')}
              size="lg"
            ...
            >
              {status.isDataDownloaded ? 'Setup Environment' : 'Initialize System'}
            </Button>
          )}
        </motion.div>
      </div>
